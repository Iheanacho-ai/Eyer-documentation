...
This use case teaches you how to filter anomalies and create an alert only when the new anomalies contain anomalies on a specific system or node.


To set up alerts for new anomalies on a specific metric and system, first, create a new Boomi process using the Eyer-Partner connector.  
This use case configures the Eyer-Partner connector with the **Dynamic Operation Properties**. 

![Eyer Partner connector](../img/image24.jpg)

For detailed instructions on setting up this connector, refer to the Configuring the [Eyer Connector documentation](https://eyer-docs.netlify.app/docs/getting-started-with-eyer/configuring-the-eyer-connector).
...
![NewAnomaliesSystem](../img/image3.png)
...
![NewAnomaliesNode](../img/image10.png)
...
![NewAnomaliesSeverity](../img/image22.png)
...
![NewAnomalies Business Rules](../img/image15.png)
