...
Repeat the create a condition process to check for updated anomalies with a severity level of "severe", but this time, replace the fourth field with the string "severe," as shown below:
