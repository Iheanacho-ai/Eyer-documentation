...
In your new Influx Telegraf folder, replace the existing telegraf.conf file with this renamed one. Then, you can make the following edits to the configuration file."
