...
Next, add [End and Continue](https://help.boomi.com/docs/atomsphere/integration/process%20building/r-atm-stop_shape_d4dda1a9-8687-4418-8a3d-afe5f9174bc1/) shapes to the lines leading out from the Mail connector, and the Rejected path of the Business rules shape. 
