...
Telegraf is an open-source agent that collects metrics from your applications. To run your Telegraf as a service, you need to download the [eyer_telegraf.conf](https://customer.support.eyer.ai/servicedesk/customer/portal/1/article/14090241) file.
